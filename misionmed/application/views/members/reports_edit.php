						...
						<div class="f-col">
							...
							<div class="row <?php if (!($id)) echo "hide"; ?> " id="datetime_edit">
								<div class="date-box">
									...
									<?php print form::input('incident_date', $form['incident_date'], ' class="form-control "'); ?>								
						...
						<div class="f-col-1">
							<div class="incident-location">
								...
								<div class="location-info">
									...
									<?php print form::input('latitude', $form['latitude'], ' class="form-control "'); ?>
									<span><?php echo Kohana::lang('ui_main.longitude');?>:</span>
									<?php print form::input('longitude', $form['longitude'], ' class="form-control "'); ?>
								</div>
							...
							<div class="f-col-bottom">
								<div class="row">
									...
									<label>
										...
										<?php print form::input('person_first', $form['person_first'], ' class="form-control "'); ?>
									</label>
									<label>
										<span><?php echo Kohana::lang('ui_main.last_name');?></span>
										<?php print form::input('person_last', $form['person_last'], ' class="form-control "'); ?>
									</label>
								</div>
								<div class="row">
									<label>
										<span><?php echo Kohana::lang('ui_main.email_address');?></span>
										<?php print form::input('person_email', $form['person_email'], ' class="form-control "'); ?>
									</label>
								</div>
							</div>
							<div style="clear:both;"></div>
