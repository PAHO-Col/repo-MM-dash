					...
					<div class="report-form">
						...
						<div class="f-col">
							...
							<div class="report_row">
								<div class="row">
									<h4><?php echo Kohana::lang('ui_main.form');?></h4>
								...
								<div class="row">
									...
									<?php print form::input('incident_title', $form['incident_title'], ' class="form-control text"'); ?>
								</div>
								<div class="row">
								...
								<div class="row <?php
									...
									<div class="date-box">
										...
										<?php print form::input('incident_date', $form['incident_date'], ' class="text form-control-sm "'); ?>								
						...
						<div class="f-col-1">
							<div class="incident-location">
								...
								<div class="location-info">
									...
									<?php print form::input('latitude', $form['latitude'], ' class="form-control text "'); ?>
									<span><?php echo Kohana::lang('ui_main.longitude');?>:</span>
									<?php print form::input('longitude', $form['longitude'], ' class="text form-control text "'); ?>
								</div>
							...
							<div id="divVideo">
								...
								print "QQQ<input type=\"text\" name=\"$this_startid\" value=\"$i\" id=\"$this_startid\">";
						...
						<div class="f-col-bottom-container">
							<!--<div class="f-col-bottom">
								<div class="row">
									...
									<label>
										<span>0000000<?php echo Kohana::lang('ui_main.first_name');?></span>
										<?php print form::input('person_first', $form['person_first'], ' class="text form-control-sm "'); ?>
									</label>
									<label>
										<span><?php echo Kohana::lang('ui_main.last_name');?></span>
										<?php print form::input('person_last', $form['person_last'], ' class="text form-control-sm "'); ?>
									</label>
								</div>
								<div class="row">
									<label>
										<span><?php echo Kohana::lang('ui_main.email_address');?></span>
										<?php print form::input('person_email', $form['person_email'], ' class="text form-control-sm "'); ?>
									</label>
								</div>
							</div>-->
							<!-- f-col-bottom-1 -->
							<div class="f-col-bottom-1">
								...
								<div class="row">
									<div class="f-col-bottom-1-col"><?php echo Kohana::lang('ui_main.action_this_report');?>?</div>
									<?php if (Auth::instance()->has_permission('reports_acciones')): ?>
									<input type="radio" name="incident_action" value="1"
									<?php if ($form['incident_action'] == 1)
									{
										echo " checked=\"checked\" ";
									}?>> <?php echo Kohana::lang('ui_main.yes');?>
									<input type="radio" name="incident_action" value="0"
									<?php if ($form['incident_action'] == 0)
									{
										echo " checked=\"checked\" ";
									}?>> <?php echo Kohana::lang('ui_main.no');?>									
									<?php else: ?>
										<?php echo $form['incident_action'] ? Kohana::lang('ui_main.yes') : Kohana::lang('ui_main.no');?>
									<?php endif; ?>
								</div>
