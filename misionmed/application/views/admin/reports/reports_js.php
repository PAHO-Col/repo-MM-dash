...
<?php require SYSPATH.'../application/views/admin/utils_js.php' ?>
		...
		{
			var statusMessage;
			//console.log("Valores: Acción - " + action + ", Confirmación - " + confirmAction + ", ID Incidente - " + incident_id);
			//alert(' valores por el momento. '+action+' ::::: ' +confirmAction+'  ::: '+incident_id);
			if( !isChecked( "incident" ) && incident_id=='' )
			{ 
				alert(' Please select at least one report.');
			} else {
				var answer = confirm('<?php echo Kohana::lang('ui_admin.are_you_sure_you_want_to'); ?> ' + confirmAction + '?')
				alert(' valores por el momento. '+action+' confirmacion ' +confirmAction+'  incidente_id'+incident_id);
				if (answer){
