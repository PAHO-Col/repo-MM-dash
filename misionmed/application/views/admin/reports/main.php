...
?>
			<div class="bg">
				...
				<div class="tabs">
					...
					<ul class="tabset">
						<li>
							<a href="?status=0" <?php if ($status != 'a' AND $status !='v' AND $status !='aa' AND $status != 'o' AND  $status != 'search') echo "class=\"active\""; ?>><?php echo Kohana::lang('ui_main.show_all');?></a>
						</li>
						...
						<li><a href="?status=aa" <?php if ($status == 'aa') echo "class=\"active\""; ?>><?php echo Kohana::lang('ui_main.awaiting_incident_action');?></a></li>
						<li>
					...
					<div class="tab action-tab active">
						<ul>
							...
							<?php endif; ?>
							<!-- SE ADICIONA BOTON PARA ACCIONES-->
							<?php if (Auth::instance()->has_permission('reports_acciones')): ?>
							<li><a href="#" onclick="reportAction('aa','<?php echo utf8::strtoupper(Kohana::lang('ui_admin.incident_action')); ?>', '');">
								<?php echo Kohana::lang('ui_admin.incident_action');?></a>
							</li>
							<?php endif; ?>
