 ...
 */
		...
		$(document).ready(function() {
			...
			$("#reportForm").validate({
				...
				messages: {
					...
					"data_accion[]": {
						required: "<?php echo addslashes(Kohana::lang('report.data_accion.required'));?>",
						range: "<?php echo addslashes(Kohana::lang('report.data_accion.between'));?>"
					},
					"data_include[]": {
		...
		//$("td > input:checkbox[name='data_accion[]']").attr('checked', $('#' + id).is(':checked'));
