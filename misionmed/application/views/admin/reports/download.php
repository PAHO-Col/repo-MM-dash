		...
		<div class="download_container">
			...
			<table class="data_points">
				...
				<tr>
					...
					<td><?php //print form::checkbox('data_accion[]', '1', in_array(1, $form['data_accion'])); ?><?php echo Kohana::lang('ui_main.data_accion');?></td>
				</tr>
				<tr>
					...
					<td><?php //print form::checkbox('data_accion[]', '0', in_array(0, $form['data_accion'])); ?><?php echo Kohana::lang('ui_main.data_no_accion');?></td>
				</tr>
				<tr>
					<td colspan="2">
						<div class="date-box">
							<h4><?php echo Kohana::lang('ui_admin.from_date');?>: <span><?php echo Kohana::lang('ui_main.date_format');?></span></h4>
							<?php print form::input('from_date', $form['from_date'], ' class="form-control-sm "'); ?>											    
						</div>
						<div class="date-box">
							<h4><?php echo Kohana::lang('ui_admin.to_date');?>: <span><?php echo Kohana::lang('ui_main.date_format');?></span></h4>
							<?php print form::input('to_date', $form['to_date'], ' class="form-control-sm "'); ?>											    
						</div>
