...
<div class="row">
<!--<label for="documento"><?= Kohana::lang('reports.documento')?></label>   -->
<?php
    // Campo de búsqueda por número de documento
	// Documento
	echo form::label('Departamento ', 'Departamento ');
	//print form::dropdown('select_campos',$select_campos);
	//print form::dropdown('select_campos',$select_campos);
	echo form::dropdown("documento",$parents_arraydpto,' class="form-control"');					
