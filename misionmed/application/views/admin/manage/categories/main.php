				...
				<div class="tabs">
					...
					<div class="tab" id="addedit" style="display:none">
						...
						<div class="tab_form_item">
							...
							<?php print form::input('category_title', $form['category_title'], ' class="form-control "'); ?><br/>
						</div>
						<div class="tab_form_item">
							...
							<div class="category_translations_form_fields">
								<?php
									foreach($locale_array as $lang_key => $lang_name) {
										...
										echo '<div class="tab_form_item">'.form::input('category_title_lang['.$lang_key.']', $form['category_title_'.$lang_key], ' class="form-control " id="category_title_'.$lang_key.'"').'</div>';
						...
						<div class="tab_form_item">
							...
							<?php print form::input('category_color', $form['category_color'], ' class="form-control "'); ?>
