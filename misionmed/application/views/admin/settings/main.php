					...
					<?php endif; ?>
						...
						<div class="l-column">
							...
							<div class="has_border">
								...
								<div id="api_key_div" <?php if (strpos($form['default_map'],'bing') === FALSE) echo "style=\"display:none\""; ?>>
									...
									<div class="api_key_div">
										...
										<div class="c_push">
											<?php print form::input('api_live', $form['api_live'], ' class="form-control "'); ?>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="has_border">
								...
								<div class="c_push">
								<?php print form::input('default_map_all', $form['default_map_all'], ' class="form-control "'); ?>
								</div>
						...
						<div class="r-column">
							...
							<div style="width: 279px; height: 90px; float: left; margin-top: 10px;">
								...
								<div class="location-info">
									...
									<?php print form::input('default_lat', $form['default_lat'], ' readonly="readonly" class="form-control "'); ?>
									<span><?php echo Kohana::lang('ui_main.longitude');?>:</span>
									<?php print form::input('default_lon', $form['default_lon'], ' readonly="readonly" class="form-control "'); ?>
								</div>
							</div>
