				...
				<div class="report-form">
					...
					<div class="sms_holder">
						<div class="l-column inverse">
							...
							<div class="row">
								<div class="tab_form_item" id="ips_id" style="display: none;">
								...
								<div class="tab_form_item" id="crue_id" style="display: none;">
							...
							<div class="row">
								<h4><a href="#"  title="<?php echo Kohana::lang("tooltips.profile_public_url"); ?>"><?php echo Kohana::lang('ui_main.public_profile_url');?></a> <span class="required"><?php echo Kohana::lang('ui_main.required'); ?></span></h4>
							...
							<div class="row">
								<h4><a href="#"  title="<?php echo Kohana::lang("tooltips.profile_new_users_password"); ?>"><?php echo Kohana::lang('ui_main.password'); ?></a> <span class="required"><?php echo Kohana::lang('ui_main.required'); ?></span></h4>
