			...
			<div class="bg">
				...
				<div class="report-form">
					...
					<div class="sms_holder">
						<div class="l-column inverse">
							...
							<div class="row">
								...
								{
									print form::dropdown('role', $role_array, $form['role'], ' readonly="readonly" onchange="toggleAdditionalFields()"');
								}
								else
								{
									print form::dropdown('role', $role_array, $form['role'],'onchange="toggleAdditionalFields();"');
								}
								?>
							</div>
						...
						<?php print form::dropdown('ips_id', $parents_arrayips, $form['crue_id']); ?>
					</div>
					<div class="tab_form_item" id="crue_id" style="display: none;">
						...
						<?php print form::dropdown('crue_id', $parents_arraycrue, $form['crue_id']); ?>
					</div>
