				...
				<div class="report-form">
					<!-- report-table -->
						...
						<!-- <?php// print form::dropdown('form_id', $forms, $form['form_id'],
							...
							<?php  
							// Aquí cambiamos 'role' a $role_array para mostrar el listado correcto
							print form::dropdown('role', $role_array, '', 'onchange="searchUser(this.value)" class="form-control"');
