 ...
 * 
 * @mr_k :::  se realiza adicion de validacion si el usuario puede ver el menu admin.
 *elhas_permission_reports_verify=Auth::instance()->has_permission('bloqueo_menu_admin');
 * 
 */
	...
	<div class="holder">
		...
		<div id="header">
			...
			<div class="info-nav">
				...
				<ul>
					<li ><a href="http://sik.sytes.net/Wiki"><?php echo Kohana::lang('ui_admin.wiki');?></a></li>
					<li><a href="http://sik.sytes.net/community_resources/"><?php echo Kohana::lang('ui_admin.faqs');?></a></li>
					<li><a href="http://sik.sytes.net/foro/index.php/"><?php echo Kohana::lang('ui_admin.forum');?></a></li>
				</ul>
					-->
			...
			<?php
			//@mr_k :::  se toma el id del usuario
			$logged_in_id = Auth::instance()->get_user()->id;			

			//@mr_k ::: se verifica el permiso			
			$elhas_permission_bloqueo_menu_admin=$this->auth->has_permission("bloqueo_menu_admin"); 
						
			if( $elhas_permission_bloqueo_menu_admin==1)
				{
			?>
