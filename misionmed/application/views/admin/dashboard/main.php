...
?>
			<div class="bg">
				...
				<?php 
				//@mr_k :: se comentarea el mensaje de seguridad por no tener https
				//echo $security_info; 
				?>
				...
				<div class="column">
					...
					<!-- info-container /// @mr_k ::: listado de reportes-->
						...
						foreach ($incidents as $incident)
						{
							...
							<div class="post">
								<ul class="post-info">
									...
									<li><a href="#" class="<?php echo $incident_action ?>"><?php echo utf8::strtoupper(Kohana::lang('ui_main.incident_action'));?>:</a></li>
				...
				<div class="column-1">
					<!-- box   /// @mr_k ::: cuadro de estadisticas-->
					...
					<div class="box">
						...
						<ul class="nav-list">
							<li>
								...
								<ul>
									<li><a href="<?php echo url::site() . 'admin/reports?status=aa' ?>"><?php echo Kohana::lang('ui_main.not_action');?></a><strong>(<?php echo $reports_unaction; ?>)</strong></li>
									
								</ul>
							</li>
							<h3><?php //echo Kohana::lang('ui_main.quick_stats');?> </h3>
							<h3><?php echo Kohana::lang('ui_main.conteo_dpto');?></h3>
							<li>
								<ul>
									
									<?php if (!empty($departamentos_count)): ?>
										<ul>
										<?php foreach ($departamentos_count as $row): ?>
											<li>
											<?php echo html::specialchars($row->nombre); ?>
							...
							<h3><?php echo Kohana::lang('ui_main.conteo_munipio');?></h3>
							<li>
								<ul>
									
									<?php if (!empty($municipios_count)): ?>

										<ul>
										<?php foreach ($municipios_count as $row): ?>
											<li>
											<?php echo html::specialchars($row->nombre); ?>
											<strong><?php echo $row->total; ?></strong>
											</li>
							...
							<li>
								...
								<ul>
									...
									foreach ($message_services as $service) {
										if ($service['name']!="SMS" and $service['name']!="Twitter"){
