...
<script type="text/javascript">
$(function() {
    var data = <?php echo $grafico_ciudad_data; ?>;
    var colors = <?php echo $grafico_ciudad_colors; ?>;
    console.log("DATA: ", <?php echo $grafico_ciudad_data; ?>);
console.log("COLORS: ", <?php echo $grafico_ciudad_colors; ?>);

    $.plot("#chartDiv", [ { data: data, color: "#49837f", bars: { show: true, barWidth: 0.6, align: "center", horizontal: true } } ], {
        series: { bars: { show: true, barWidth: 0.6, align: "center", horizontal: true } },
