...
<div class="bg">
    <h2>
        ...
        <a href="<?php print url::site() ?>admin/stats/formulario/"><?php echo Kohana::lang('stats.formulario');?></a>
        
        <a href="<?php print url::site() ?>admin/stats/formulario_d/"><?php echo Kohana::lang('stats.formulario_d');?></a></h2>
            ...
            <p>
                ...
                <?php  echo form::open($form_action , array('method' => 'get', 'style' => "display: inline;")); ?> 
                 ...
                 <?php //echo Kohana::lang('stats.choose_date_range'); ?>:
                    <?php echo Kohana::lang('stats.choose_date_range');?>: 
                    <a href="<?php/// print url::site() ?>admin/stats/formulario/?range=30"><?php echo Kohana::lang('stats.time_range_1');?></a> 
					<a href="<?php //print url::site() ?>admin/stats/formulario/?range=90"><?php echo Kohana::lang('stats.time_range_2');?></a> 
					<a href="<?php //print url::site() ?>admin/stats/formulario/?range=180"><?php echo Kohana::lang('stats.time_range_3');?></a> 
					<a href="<?php print url::site() ?>admin/stats/formulario/"><?php echo Kohana::lang('stats.time_range_all');?></a>
    ...
    <table style="border-collapse: collapse; width: 60%; max-width: 600px; font-family: Arial, sans-serif; margin-bottom: 20px;">
        <thead>
