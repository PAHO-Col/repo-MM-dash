...
class admin_Core {
	...
	public static function main_tabs()
	{
		...
		else
		{
			...
			$tabs['stats/reportsc'] = Kohana::lang('ui_admin.stats');
		...
		else
		{
			...
			if ($user)
			{
				...
				$main_right_tabs = (Auth::instance()->has_permission('users', $user))
					...
					: $main_right_tabs;
				// Check permissions for vehiculos panel validacion de usuarios
				$main_right_tabs = (Auth::instance()->has_permission('managementcu', $user))
				? arr::merge($main_right_tabs, array('managementcu' => Kohana::lang('ui_admin.management_cars_usr')))
				: $main_right_tabs;
			}
		}
	...
	public static function user_subtabs($this_sub_page = FALSE, $display_roles = FALSE)
	{
		...
		if ($display_roles)
		{
			$menu .= ($this_sub_page == "crue") ? Kohana::lang('ui_admin.manage_crue') : "<a
			href=\"".url::site()."admin/users/crue/\">".Kohana::lang('ui_admin.manage_crue')."</a>";
		}
		//mr_k ::: se crea nueva validacion ips,,, pendiente lo de display_roles
		if ($display_roles)
		{
			$menu .= ($this_sub_page == "ips") ? Kohana::lang('ui_admin.manage_ips') : "<a
			href=\"".url::site()."admin/users/ips/\">".Kohana::lang('ui_admin.manage_ips')."</a>";
		}
	...
	/**
	 * GESTION ;;; Generate Manage Sub Tab Menus
	 * submenu de gestion validacion de carros y usuarios 
	 * @mr_k :: 
	 * @param string $this_sub_page
	 * @return string $menu
	 */

	public static function managecu_subtabs($this_sub_page = FALSE)
	{
		$menu = "";

		$menu .= ($this_sub_page == "managementcu") ? Kohana::lang('management_cu.menu_gestion') : "<a href=\"".url::site()."admin/managementcu/\">".Kohana::lang('management_cu.menu_gestion')."</a>";

		$menu .= ($this_sub_page == "cars") ? Kohana::lang('management_cu.menu_cars') : "<a href=\"".url::site()."admin/managementcu/cars/\">".Kohana::lang('management_cu.menu_cars')."</a>";

		$menu .= ($this_sub_page == "persons") ? Kohana::lang('management_cu.menu_persons') : "<a href=\"".url::site()."admin/managementcu/persons/\">".Kohana::lang('management_cu.menu_persons')."</a>";

		$menu .= ($this_sub_page == "instalacion") ? Kohana::lang('management_cu.menu_instalacion') : "<a href=\"".url::site()."admin/managementcu/instalacion/\">".Kohana::lang('management_cu.menu_instalacion')."</a>";
