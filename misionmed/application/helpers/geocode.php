...
class geocode_Core {
	 ...
	 */
	 ...
	 static public function nominatim($address) {
		...
		//$url = "https://nominatim.openstreetmap.org/search?format=json&addressdetails=1&accept-language=en_US&q=bosques+de+san+pablo+medellin&zoom=200";
...
//.k. 
	...
	static public function nominatimxxxxx($address) {
		$payload = FALSE;
		$result = FALSE;
		...
		//mr_k ::: se modifica debido a cambios en api open street map	
		//$url = "https://nominatim.openstreetmap.org/search?" . http_build_query($params);
		//$url = "https://184.104.179.133/search?" . http_build_query($params);
		$url = "https://nominatim.openstreetmap.org/search?format=json&addressdetails=1&accept-language=en_US&q=bosques+de+san+pablo+medellin&zoom=200";
