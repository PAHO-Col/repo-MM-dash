...
class Themes_Core {
	...
	*/
	...
	public function requirements()
	{
		...
		//@mr_k :: se adiciona bootstrap para el sistema
		//Requirements::css('media/css/sb-admin.css');
		//Requirements::css('media/css/sb-admin-2.min');		
		//Requirements::js('media/js/bootstrap.min.js');
		//Requirements::css('media/css/bootstrap.min.css');	
		//Requirements::js('media/js/bootstrap4.js');
		//Requirements::css('media/css/bootstrap4.css');	
...
SCHEDULER;
	...
	*/
	...
	public static function load_theme($theme)
	{
		...
		Requirements::js('themes/Default/js/bootstrap4.js');
		Requirements::css('themes/Default/css/bootstrap4.css');	
