...
class Incidents_Api_Object extends Api_Object_Core {
	 ...
	 * @mr_k toma los valores de la base de datos.
	 */
	public function _get_incidents($where = array())
	{
		// STEP 1.
		// Get the incidents
		if($this->by=="allnoactivos")
		{
		$items = Incident_Model::get_incidents_noactivos($where, $this->list_limit, $this->order_field, $this->sort);
		}	
		else
		{
