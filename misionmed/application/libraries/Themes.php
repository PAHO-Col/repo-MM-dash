...
class Themes_Core {
	...
	*/
	...
	public function requirements()
	{
		...
		//@mr_k ::: se adiciona liberia actualizada de jquery 1.9
		//Requirements::js("media/js/jquery_191.min.js");
		//
	...
	public function admin_requirements()
	{
		...
		//@mr_k
		//Requirements::js('media/js/jquery.min.js');
		//Requirements::js('media/js/jquery1_12_4.js');		
		//Requirements::js('media/js/bootstrap.min3.js');			
		Requirements::js('media/js/bootstrap_232.min.js');				
		Requirements::css('media/css/sb-admin-2.min.css');
		Requirements::css('media/css/bootstrap.min3.css');	
		//
	...
	public function frontend_requirements()
	{
		...
		//@mr_k ::: se adicionan nuevos		
		//Requirements::js('media/css/style.css', null, 200);
		//Requirements::css('media/css/sb-admin-2.min.css', null, 10);			
		//Requirements::css('media/css/bootstrap.min3.css', null, 100);
		//Requirements::css('media/css/bootstrap.min3.css');
		//Requirements::js('media/js/bootstrap_232.min.js');	
	...
	*/
	...
	private static function load_theme_css($theme)
	{
		...
		if (empty($meta['CSS']))
		{
			...
			$meta['CSS'][] = 'style';
			$meta['CSS'][] = '_default';
			//$meta['CSS'][] = 'bootstrap.min3';
			//$meta['CSS'][] = 'sb-admin-2.min';
			$meta['CSS'][] = $theme;
		}
		else
		{
