...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><?php echo $site_name; ?> Mapa de Calor</title>
		<?php
		// System Files
		...
		<tr style="height:40px;">
			<td class="header">
				...
				<div class="underlinemenu">
					<ul>
						<li>
							<a href="<?php echo url::base(); ?>"><?php echo Kohana::lang('heatmap.home'); ?></a>
							
						</li>
						<li><a href="<?php echo url::site()."bigmap/"; ?>"><?php echo Kohana::lang('heatmap.bigmap'); ?></a></li>
