	...
	$link_path_prefix = "")
    {
		...
		foreach ($clusters as $cluster)
		{
			...
			$json_item .= "\"name\":\"" . str_replace(chr(10), ' ', str_replace(chr(13), ' ', "<a target = " . $link_target . " href=" . url::base() . $admin_path . $link_path_prefix
				. "index.php/reports/index/?" . $_SERVER['QUERY_STRING'] . "&sw=" . $southwest . "&ne=" . $northeast . ">" . $cluster_count . " ".Kohana::lang('ui_main.cluster_name_reports')."</a>")) . "\",";
		...
		foreach ($singles as $single)
		{
			...
			$json_item .= "\"properties\": {";
			$json_item .= "\"name\":\"" . str_replace(chr(10), ' ', str_replace(chr(13), ' ', "<a target = ".$link_target." href=" . url::base().$admin_path.$link_path_prefix
					. "index.php/reports/".$view_or_edit."/" . $single['id'] . "/>".str_replace('"','\"',$single['incident_title'])."</a>")) . "\",";
