...
class ORM_Core {
	...
	{
		////print_r("<br>funcion ORM select_list");
		if ($key === NULL)
		{
	 ...
	 * @chainable
	 * @return  ORM
	 * @mr_koyote la funcion que guarda los datos y no estoy seguro si los actualiza 
	 * eso falta definir
	 * 
	 */
...
/****
 * 
 * funcion creada para el update de cvs
 * @mr_koyote
 * sik::SinergiaInformatik.
 */
...
/**
	 ...
	 * @return  ORM
	 */
	public function delete_ic($id = NULL)
	{
		

		// Delete this object
		$this->db->where('incident_id', $id)->delete($this->table_name);
	...
	{
	//	print_r("<br>ORM.PHP function load_values");
